...
#> INFO  [2026-04-24 19:22:50] ** Raw data from DIANN imported successfully.
#> INFO  [2026-04-24 19:22:50] ** Raw data from DIANN cleaned successfully.
#> INFO  [2026-04-24 19:22:50] ** Using provided annotation.
#> INFO  [2026-04-24 19:22:50] ** Run labels were standardized to remove symbols such as '.' or '%'.
#> INFO  [2026-04-24 19:22:50] ** Filtering on Global Q Value < 0.01
#> INFO  [2026-04-24 19:22:50] ** MBR was used to analyze the data. Now setting names and filtering
#> INFO  [2026-04-24 19:22:50] -- LibPGQValue < 0.01
#> INFO  [2026-04-24 19:22:50] -- LibQValue < 0.01
#> INFO  [2026-04-24 19:22:50] ** The following options are used:
#>   - Features will be defined by the columns: PeptideSequence, PrecursorCharge, FragmentIon, ProductCharge
#>   - Shared peptides will be removed.
#>   - Proteins with single feature will not be removed.
#>   - Features with less than 3 measurements across runs will be removed.
#> INFO  [2026-04-24 19:22:50] ** Sequences containing DECOY, Decoys are removed.
#> INFO  [2026-04-24 19:22:50] ** Sequences containing \(UniMod\:35\) are removed.
#> INFO  [2026-04-24 19:22:50] ** Features with all missing measurements across runs are removed.
#> INFO  [2026-04-24 19:22:50] ** Shared peptides are removed.
#> INFO  [2026-04-24 19:22:50] ** Multiple measurements in a feature and a run are summarized by summaryforMultipleRows: max
#> INFO  [2026-04-24 19:22:50] ** Features with one or two measurements across runs are removed.
#> INFO  [2026-04-24 19:22:50] ** Run annotation merged with quantification data.
#> WARN  [2026-04-24 19:22:50] The following features have missing values in at least one run. ASGSGGGSAALGPSGFGPSGGSGTK(UniMod:121)LPK_3_Frag3_1,
...
#> INFO  [2026-04-24 19:22:50] ** Updated quantification data to make balanced design. Missing values are marked by NA
#> INFO  [2026-04-24 19:22:50] ** Finished preprocessing. The dataset is ready to be processed by the dataProcess function.
...
#> INFO  [2026-04-24 19:22:51] ** Raw data from DIANN imported successfully.
#> INFO  [2026-04-24 19:22:51] ** Raw data from DIANN cleaned successfully.
#> INFO  [2026-04-24 19:22:51] ** Using provided annotation.
#> INFO  [2026-04-24 19:22:51] ** Run labels were standardized to remove symbols such as '.' or '%'.
#> INFO  [2026-04-24 19:22:51] ** Filtering on Global Q Value < 0.01
#> INFO  [2026-04-24 19:22:51] ** MBR was used to analyze the data. Now setting names and filtering
#> INFO  [2026-04-24 19:22:51] -- LibPGQValue < 0.01
#> INFO  [2026-04-24 19:22:51] -- LibQValue < 0.01
#> INFO  [2026-04-24 19:22:51] ** The following options are used:
#>   - Features will be defined by the columns: PeptideSequence, PrecursorCharge, FragmentIon, ProductCharge
#>   - Shared peptides will be removed.
#>   - Proteins with single feature will not be removed.
#>   - Features with less than 3 measurements across runs will be removed.
#> INFO  [2026-04-24 19:22:51] ** Sequences containing DECOY, Decoys are removed.
#> INFO  [2026-04-24 19:22:51] ** Sequences containing \(UniMod\:35\) are removed.
#> INFO  [2026-04-24 19:22:51] ** Features with all missing measurements across runs are removed.
#> INFO  [2026-04-24 19:22:51] ** Shared peptides are removed.
#> INFO  [2026-04-24 19:22:51] ** Multiple measurements in a feature and a run are summarized by summaryforMultipleRows: max
#> INFO  [2026-04-24 19:22:51] ** Features with one or two measurements across runs are removed.
#> INFO  [2026-04-24 19:22:51] ** Run annotation merged with quantification data.
#> WARN  [2026-04-24 19:22:51] The following features have missing values in at least one run. AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag1_1,
#>  AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag2_1,
#>  AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag3_1,
#>  AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag4_1,
#>  AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag5_1,
...
#>  AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag11_1,
#>  AVHEQLAALSQGPISK(UniMod:121)PK_4_Frag12_1
#> INFO  [2026-04-24 19:22:51] ** Updated quantification data to make balanced design. Missing values are marked by NA
#> INFO  [2026-04-24 19:22:51] ** Finished preprocessing. The dataset is ready to be processed by the dataProcess function.
