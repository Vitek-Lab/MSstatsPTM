...
information. Each PTM and Protein include a list of data.tables: `ProcessedData`
is a data.table of reformatted input of dataSummarizationPTM, `RunlevelData` is 
